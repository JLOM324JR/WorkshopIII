...
app.get('/about', function (req, res) {
    ...
    var quote = 'I DO NOT WANT PERFECT LIFE. I WANT A HAPPY LIFE.'
    res.render('pages/about', { name: name,id: id, major: major, bdate: bdate, quote:quote});
});
